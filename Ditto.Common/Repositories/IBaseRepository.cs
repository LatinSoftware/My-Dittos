...
public interface IBaseRepository<TEntity> where TEntity : class
{
    ...
    Task<PaginationModel<TEntity>> GetAsync(int skip, int limit = 10, Expression<Func<TEntity, bool>> filter = null, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null, string includeProperties = "");
